exports.campusweiseAvgAttendance = async (data, name) => {
    var card = {
        ...
        "body": [
            ...
            },
            {
                ...
                "items": [
                    {
                        "type": "TextBlock",
                        "text": "Campuswise Attendance Detail",
                        "horizontalAlignment": "Center",
                        "color": "Accent",
                        "weight": "Bolder",
                        "size": "Medium"
...
exports.schoolwiseAvgAttendance = async (data, name) => {
    var card = {
        "type": "AdaptiveCard",
        "version": "1.0",
        "body": [
...
exports.deptwiseAvgAttendance = async (data, name) => {
    var card = {
        "type": "AdaptiveCard",
        "version": "1.0",
        "body": [
...
exports.semwiseAvgAttendance = async (data, name) => {
    var card = {
        "type": "AdaptiveCard",
        "body": [
            {
...
exports.classwiseAvgAttendance = async (data, name) => {
    var card = {
        "type": "AdaptiveCard",
        "body": [
            {
            ...
            },
            {
                ...
                "items": [
                    {
                        "type": "TextBlock",
                        "text": `${name} semester - Attendance Detail`,
                        "horizontalAlignment": "Center",
                        "color": "Accent",
                        "weight": "Bolder",
                        "size": "Medium"
...
exports.sectionwiseAvgAttendance = async (data, name) => {
    var card = {
        "type": "AdaptiveCard",
        "body": [
            {
